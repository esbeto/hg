...
/***************************** TEST RELATION BY KARMRAJ *************************************/
	...
	public function attributeLabels()
	{
		return array(
			...
			'employee_transaction_designation_id' => 'Designación',
			'employee_transaction_nationality_id' => 'Nacionalidad',
			'employee_transaction_department_id' => 'Departamento',
			'employee_transaction_organization_id' => 'Organization',
			'employee_transaction_languages_known_id' => 'Idiomas Hablados',
			'employee_transaction_emp_photos_id' => 'Photos',
			'employee_no' => 'Número de Empleado',
			'employee_first_name' => 'Nombre',
			'employee_middle_name' => 'Apellido Paterno',
			'employee_last_name' => 'Apellido Materno',
			'employee_name_alias' => 'Alias',
			'employee_dob' => 'Fecha de Nacimiento',
			'employee_birthplace' => 'Lugar de Nacimiento',
			'employee_gender' => 'Sexo',
			'employee_bloodgroup' => 'Grupo de Sangre',
			'employee_marital_status' => 'Estado Marital',
			'employee_private_email' => 'Correo Electrónico Personal',
			'employee_organization_mobile' => 'Teléfono Móvil',
			'employee_private_mobile' => 'Teléfono Móvil Personal',
			'employee_pancard_no' => 'No RFC',
			'employee_account_no' => 'No Cuenta',
			'employee_joining_date' => 'Fecha de Ingreso',
			'employee_probation_period' => 'Período de Prueba',
