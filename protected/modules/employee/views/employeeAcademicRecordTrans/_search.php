...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'employee_academic_record_trans_id'); ?>
		<?php echo $form->textField($model,'employee_academic_record_trans_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'employee_academic_record_trans_user_id'); ?>
		<?php echo $form->textField($model,'employee_academic_record_trans_user_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'employee_academic_record_trans_qualification_id'); ?>
		<?php echo $form->textField($model,'employee_academic_record_trans_qualification_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'employee_academic_record_trans_eduboard_id'); ?>
		<?php echo $form->textField($model,'employee_academic_record_trans_eduboard_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'employee_academic_record_trans_year_id'); ?>
