...
<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
	<li class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active">
		<?php echo CHtml::link('Perfil Personal', array('updateTab1', 'id'=>$_REQUEST['id'])); ?>
	</li>
	<!--
	<li class="ui-state-default ui-corner-top">
		<?php echo CHtml::link('Gaurdian Info', array('updateprofiletab2', 'id'=>$_REQUEST['id'])); ?>
	</li>
	-->
	<li class="ui-state-default ui-corner-top">
		<?php echo CHtml::link('Info Dirección', array('updateprofiletab3', 'id'=>$_REQUEST['id'])); ?>
	</li>
	<!--
	<li class="ui-state-default ui-corner-top">
		<?php echo CHtml::link('Academic Record', array('EmployeeAcademicRecords', 'id'=>$_REQUEST['id'])); ?>
	</li>
	<li class="ui-state-default ui-corner-top">
		<?php echo CHtml::link('Document', array('Employeedocs', 'id'=>$_REQUEST['id'])); ?>
	</li>
	-->
</ul>
...
<div class="row">
	...
	<div class="row-left">
		...
		<?php echo $form->dropDownList($info,'employee_gender',$info->getGenderOptions(), array('empty' => 'Seleccionar','tabindex'=>17)); ?><span class="status">&nbsp;</span>
...
<div class="row">
	...
	<div class="row-right">
		...
		<?php echo $form->dropDownList($info,'employee_bloodgroup',$info->getBloodGroup(), array('empty' => 'Seleccionar','tabindex'=>18)); ?><span class="status">&nbsp;</span>
...
<div class="row">
	...
	<div class="row-left">
		...
		<?php echo $form->dropDownList($model,'employee_transaction_nationality_id',Nationality::items(), array('empty' => 'Seleccionar','tabindex'=>19)); ?><span class="status">&nbsp;</span>
		<?php echo $form->error($model,'employee_transaction_nationality_id'); ?>
	</div>

	<div class="row-right">
		<?php echo $form->labelEx($info,'employee_marital_status'); ?>
		<?php echo $form->dropDownList($info,'employee_marital_status',$info->getMaritialStatus(), array('empty' => 'Seleccionar')); ?><span class="status">&nbsp;</span>
...
<div class="row">
	...
	<div class="row-right">
	      ...
	      <?php echo $form->dropDownList($model,'employee_transaction_department_id',Department::items(), array('empty' => 'Seleccionar','tabindex'=>8)); ?><span class="status">&nbsp;</span>
...
<div class="row">
	...
	<div class="row-left">
	      ...
	      <?php echo $form->dropDownList($model,'employee_transaction_designation_id',EmployeeDesignation::items(), array('empty' => 'Seleccionar','tabindex'=>7)); ?><span class="status">&nbsp;</span>
...
<div class="row">
	<div class="row-left">
		...
		<?php echo $form->dropDownList($info,'employee_type',array("empty"=>"Seleccionar","1"=>"Teaching","0"=>"Non Teaching"),array('tabindex'=>25)); ?><span class="status">&nbsp;</span>
		<?php echo $form->error($info,'employee_type'); ?>
	</div>
	<div class="row-right">
		<?php echo $form->labelEx($lang,'languages_known1'); ?>
		<?php echo $form->dropDownList($lang,'languages_known1', CHtml::listData(Languages::model()->findAll(),'languages_id','languages_name'), array('empty'=>'Seleccionar','tabindex'=>25)); ?><span class="status">&nbsp;</span>
