...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<div class="row-left">
			...
			<?php echo $form->dropdownList($info,'student_gender',$info->getGenderOptions(), array('empty' => 'Seleccionar')); ?><span class="status">&nbsp;</span>
	...
	<div class="row">
		<div class="row-left">
			...
			<?php echo $form->dropdownList($info,'student_bloodgroup',$info->getBloodGroup(),
				array('empty' => 'Seleccionar')); ?><span class="status">&nbsp;</span>
			<?php echo $form->error($info,'student_bloodgroup'); ?>
		</div>
		<div class="row-right">
			<?php echo $form->labelEx($model,'student_transaction_nationality_id'); ?>
			<?php echo $form->dropDownList($model,'student_transaction_nationality_id',Nationality::items(),
				array('empty' => 'Seleccionar')); ?><span class="status">&nbsp;</span>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'student_academic_term_period_tran_id',AcademicTermPeriod::items(),
				array(
				'prompt' => 'Seleccionar',
				'ajax' => array(
					'type'=>'POST',
		...
		<div class="row-right">
			...
			<?php
				...
				if(isset($model->student_academic_term_name_id))
					...
					echo $form->dropDownList($model,'student_academic_term_name_id',array() ,array('prompt' => 'Seleccionar'));
			?><span class="status">&nbsp;</span>
	...
	<div class="row">
			...
			<?php echo $form->dropDownList($lang,'languages_known1',Languages::items(),
				array('empty'=>'Seleccionar')); ?><span class="status">&nbsp;</span>
			...
			<?php echo $form->dropDownList($lang,'languages_known2',Languages::items(),
				array('empty'=>'Seleccionar')); ?><span class="status">&nbsp;</span>
	...
	<div class="row last">
		...
		<?php echo $form->dropDownList($model,'student_transaction_course_id', CHtml::listData(CourseMaster::model()->findAll(), 'course_master_id', 'course_name'),
			array('empty'=>'Seleccionar')); ?><span class="status">&nbsp;</span>
