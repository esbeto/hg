...
class StudentTransaction extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'student_transaction_nationality_id' => 'Nacionalidad',
			...
			'student_academic_term_period_tran_id' => 'Año Académico',
			'student_academic_term_name_id' => 'Semestre',
			'student_enroll_no' => 'Matrícula',
			'student_first_name' => 'Nombre',
			'student_middle_name' => 'Apellido',
			...
			'student_transaction_detain_student_flag'=>'Estado del Alumno',
			'student_transaction_course_id'=>'Clase',
			'status_name'=>'Estado'
		);
	}
