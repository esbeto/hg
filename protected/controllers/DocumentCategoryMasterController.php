...
class DocumentCategoryMasterController extends RController
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['DocumentCategoryMaster'];
	...
	{
		$model=DocumentCategoryMaster::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='document-category-master-form')
		{
