...
<h1>Ingresar</h1>
<p>Favor de llenar la forma con sus datos:</p>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php endif; ?>
        ...
        <tr style="padding-top: 10px;">
            <td>
		<?php echo CHtml::link('Olvidó su contraseña?',array('forgotpassword'), array('style'=>"color:#000; margin-left:20px;",'tabindex'=>4)); ?>
		<?php echo CHtml::submitButton('Ingresar',array('align'=>'center','class'=>'submit','id'=>'login-button','tabindex'=>3)); ?>
