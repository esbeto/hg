...
<li><label>Nombre:</label><?php echo $student->student_first_name; ?></li>
<li><label>Apellidos:</label><?php echo $student->student_last_name; ?></li>
<li><label>Sexo:</label> <?php echo $student->student_gender; ?></li>
<li><label>Nacimiento:</label> <?php echo $student->student_dob; ?></li>
<li><label>Email:</label><?php echo $student->student_email_id_1; ?> </li>
</ul>
<div class="portlet box blue" style="width:92%;	">
<i class="icon-reorder"></i>
 <div class="portlet-title">Detalles de la Clase
 </div>
